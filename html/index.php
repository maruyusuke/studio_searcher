...
<html lang="ja">
    <head>
        ...
        <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDoFkXG-PUNK9Kq9YTRz6BSQVq-uzyC9i4&libraries=&v=weekly" async defer></script> -->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDoFkXG-PUNK9Kq9YTRz6BSQVq-uzyC9i4&callback=Function.prototype" async defer></script>
